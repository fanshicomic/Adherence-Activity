...
<body id="page-top" class="exercise-3-body" day="1">
    		...
    		<div class="row text-center">
    			...
    			<div class="text-left col-lg-6 col-lg-offset-3">
    				<div class="row text-center">
    					<div class="text-left">
    						<h4>Instructions:</h4>
		                	<p>Click the update button to signify the ingestion of the tablet and update the drug taken time.</p>
		                </div>
		    			<table class="day-table" exercise="3">
		    				<tbody class="day-table-tbody">
		    					<?php show_day_table(3); ?>
		    				</tbody>
		    			</table>
	    			</div>
            	</div>
    ...
    <script type="text/javascript">show_activity(3);</script>
    <script type="text/javascript">show_result(3);</script>
</body>
</html>